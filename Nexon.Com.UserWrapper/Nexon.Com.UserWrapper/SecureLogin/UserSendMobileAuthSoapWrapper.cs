...
{
	internal class UserSendMobileAuthSoapWrapper : SoapWrapperBase<securelogin, UserSendMobileAuthSoapResult>
	{
		...
		protected override void ExecuteImpl(out int errorCode, out string errorMessage)
		{
			...
			string authSeq;
			string text;
			errorCode = base.Soap.SendSMSAuthOwnerCfm(this._n4ServiceCode, 12, this._n1MobileCompanyCode, this._strMobilePhone1, this._strMobilePhone2, this._strMobilePhone3, this._strSsn, this._strName, this._n4NexonSN, this._strClientIP, out authLogSN, out authPGCode, out pccSeq, out authSeq, out text);
