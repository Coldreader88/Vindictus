...
{
	internal class UserSsnCheckMatchFullSoapWrapper : SoapWrapperBase<character, UserSsnCheckMatchResult>
	{
		...
		public UserSsnCheckMatchFullSoapWrapper()
		{
		...
		{
			errorCode = base.Soap.CheckMatchUserSsn_Full(this.ServiceCode, this.NexonSN, this.NexonID, this.Ssn);
