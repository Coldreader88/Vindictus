...
namespace Devcat.Core.Math.GeometricAlgebra
{
	...
	public struct Quaternion : IEquatable<Quaternion>
	{
		...
		public static Quaternion CreateFromAxisAngle(Vector3 axis, float angle)
		{
			...
			float w = (float)System.Math.Cos((double)num);
			Quaternion result;
		...
		public static Quaternion CreateFromRotationMatrix(Matrix matrix)
		{
			...
			if (num > 0f)
			{
				float num2 = (float)System.Math.Sqrt((double)(num + 1f));
				result.W = num2 * 0.5f;
				num2 = 0.5f / num2;
			...
			{
				float num3 = (float)System.Math.Sqrt((double)(1f + matrix.M11 - matrix.M22 - matrix.M33));
			...
			{
				float num5 = (float)System.Math.Sqrt((double)(1f + matrix.M22 - matrix.M11 - matrix.M33));
			...
			float num7 = (float)System.Math.Sqrt((double)(1f + matrix.M33 - matrix.M11 - matrix.M22));
		...
		public static Quaternion Slerp(Quaternion quaternion1, Quaternion quaternion2, float amount)
		{
			...
			{
				float num4 = (float)System.Math.Acos((double)num);
				float num5 = (float)(1.0 / System.Math.Sin((double)num4));
				num2 = (float)System.Math.Sin((double)((1f - amount) * num4)) * num5;
				num3 = (flag ? ((float)(-(float)System.Math.Sin((double)(amount * num4))) * num5) : ((float)System.Math.Sin((double)(amount * num4)) * num5));
			}
			Quaternion result;
		...
		public static Quaternion Lerp(Quaternion quaternion1, Quaternion quaternion2, float amount)
		{
			...
			float num4 = 1f / (float)System.Math.Sqrt((double)num3);
			result.X *= num4;
			result.Y *= num4;
			result.Z *= num4;
			result.W *= num4;
