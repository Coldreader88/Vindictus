...
namespace Devcat.Core.Math.GeometricAlgebra
{
	...
	public struct Vector3 : IEquatable<Vector3>
	{
		...
		{
			return (float)(System.Math.Atan2((double)direction.X, (double)direction.Y) - 1.5707963267948966);
		}

		public static Vector3 GetDirectionFromAngle(float angle)
		{
			angle += 1.57079637f;
			return new Vector3((float)System.Math.Cos((double)angle), (float)System.Math.Sin((double)angle), 0f);
		}
