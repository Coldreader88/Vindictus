...
{
	public static class MMOChannelServiceOperations
	{
		public static IEnumerable<Type> Types
		{
			get
			{
				...
				{
					if (!(type2.Namespace != typeof(MMOChannelServiceOperations).Namespace) && typeof(Operation).IsAssignableFrom(type2))
					{
						yield return type2;
					}
				}
		...
		public static IDictionary<Type, int> TypeConverters
		{
			get
			{
				return MMOChannelServiceOperations.Types.GetConverter();
			}
		}
	}
}
