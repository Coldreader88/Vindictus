...
{
	public static class MicroPlayServiceOperations
	{
		public static IEnumerable<Type> Types
		{
			get
			{
				...
				{
					if (!(type2.Namespace != typeof(MicroPlayServiceOperations).Namespace) && typeof(Operation).IsAssignableFrom(type2))
					{
						yield return type2;
					}
				}
		...
		public static IDictionary<Type, int> TypeConverters
		{
			get
			{
				return MicroPlayServiceOperations.Types.GetConverter();
			}
		}
	}
}
