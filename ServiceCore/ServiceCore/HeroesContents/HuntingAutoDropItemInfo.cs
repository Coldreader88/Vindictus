...
{
	[Table(Name = "dbo.HuntingAutoDropItemInfo")]
	public class HuntingAutoDropItemInfo
	{
		...
		[Column(Storage = "_ToolItemClass", DbType = "NVarChar(128)")]
		public string ToolItemClass
		{
			get
			{
				return this._ToolItemClass;
			}
			set
			{
				if (this._ToolItemClass != value)
				{
					this._ToolItemClass = value;
				}
			}
		}
