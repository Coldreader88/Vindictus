...
{
	[Serializable]
	public sealed class EnhanceItem : Operation
	{
		...
		public EnhanceItem(long itemID, string materialSlot1, string materialSlot2, string additionalMaterial, bool isEvent, bool isCheat)
		{
			this.ItemID = itemID;
