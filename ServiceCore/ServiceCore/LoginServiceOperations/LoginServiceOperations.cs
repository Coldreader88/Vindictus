...
{
	public static class LoginServiceOperations
	{
		public static IEnumerable<Type> Types
		{
			get
			{
				...
				{
					if (!(type2.Namespace != typeof(LoginServiceOperations).Namespace) && typeof(Operation).IsAssignableFrom(type2))
					{
						yield return type2;
					}
				}
		...
		public static IDictionary<Type, int> TypeConverters
		{
			get
			{
				return LoginServiceOperations.Types.GetConverter();
			}
		}
	}
}
