...
namespace Nexon.Com.Playfeed.SDK.Utility
{
	public class HttpRequestUtility
	{
		...
		{
			return HttpRequestUtility.SendRequest(new HttpRequestUtility.RequestEntity(url, proxyIp, "POST", "application/json", (values != null) ? Encoding.UTF8.GetBytes(values) : null, null));
		}
		...
		private const string PLAYSDKVER = "PlayfeedSDK V100";
