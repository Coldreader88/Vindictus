...
{
	[Table(Name = "dbo.UserCountLogChanneling")]
	public class UserCountLogChanneling : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		[Column(Storage = "_QuestDS", DbType = "Int NOT NULL")]
		public int QuestDS
		{
			get
			{
		...
		[Column(Storage = "_ChannelingCode", DbType = "TinyInt NOT NULL")]
		public byte ChannelingCode
		{
			get
			{
				return this._ChannelingCode;
			}
			set
			{
				if (this._ChannelingCode != value)
				{
					this.SendPropertyChanging();
					this._ChannelingCode = value;
					this.SendPropertyChanged("ChannelingCode");
				}
			}
		}
		...
		protected virtual void SendPropertyChanging()
		{
			...
			{
				this.PropertyChanging(this, UserCountLogChanneling.emptyChangingEventArgs);
			}
		}
