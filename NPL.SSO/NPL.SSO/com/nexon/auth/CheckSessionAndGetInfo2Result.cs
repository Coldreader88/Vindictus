...
namespace NPL.SSO.com.nexon.auth
{
	...
	[Serializable]
	public class CheckSessionAndGetInfo2Result
	{
		...
		public byte uRegisteredPC
		{
			get
			{
				return this.uRegisteredPCField;
			}
			set
			{
				this.uRegisteredPCField = value;
			}
		}
		...
		private byte uRegisteredPCField;
	}
}
